...
const (
	...
	HelloService_ReplyHello_FullMethodName = "/hello.HelloService/ReplyHello"
)
...
type HelloServiceClient interface {
	...
	ReplyHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloServiceClient) ReplyHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, HelloService_ReplyHello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServiceServer interface {
	...
	ReplyHello(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedHelloServiceServer) ReplyHello(context.Context, *HelloRequest) (*HelloResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReplyHello not implemented")
}
...
func _HelloService_ReplyHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloServiceServer).ReplyHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloService_ReplyHello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).ReplyHello(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HelloService_ReplyHello_Handler,
		},
	},
...
const (
	Health_Check_FullMethodName = "/hello.Health/Check"
)
